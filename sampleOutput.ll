...
store i32 5, i32* %RSP_1-8, align 1
%41 = trunc i128 %XMM0_1 to i64
%42 = bitcast i64 %41 to double
store double %42, double* %RSP_1-16, align 1
store i32 100, i32* %RSP_1-20, align 1
%ESI_0 = load i32, i32* %RSP_1-20, align 1
%RSI_1 = zext i32 %ESI_0 to i64
%51 = load double, double* %RSP_1-16, align 1
...
%XMM1_0 = trunc <16 x float> %ZMM1_0 to i128
%162 = zext i32 %EAX_3 to i128
...
store i64 4195713, i64* %RSP_10-8
...
%XMM1_5 = trunc <16 x float> %ZMM1_5 to i128
%342 = zext i32 %EAX_11 to i128
%343 = and i128 %XMM1_5, -18446744073709551616
%XMM1_6 = or i128 %342, %343
%YMM1_5 = trunc <16 x float> %ZMM1_5 to i256
...
%EAX_12 = fptosi i128 %XMM1_7 to i32
...
store i64 4195797, i64* %RSP_12-8
...
%RBP_4 = load i64, i64* %RSP_8-8, align 1
