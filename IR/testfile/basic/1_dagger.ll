...
bb_5FA:                                           ; preds = %entry_fn_5FA
  ...
  %EAX_1 = mul i32 %EAX_0, %22
  %RAX_2 = zext i32 %EAX_1 to i64
  %AX_1 = trunc i32 %EAX_1 to i16
  %AL_1 = trunc i32 %EAX_1 to i8
  %23 = lshr i32 %EAX_1, 8
  %AH_1 = trunc i32 %23 to i8
  ...
  %AX_2 = trunc i32 %EAX_1 to i16
  %AL_2 = trunc i32 %EAX_1 to i8
  %24 = lshr i32 %EAX_1, 8
  %AH_2 = trunc i32 %24 to i8
...
define void @fn_6A0(%regset* noalias nocapture) {
entry_fn_6A0:
  %RIP_ptr = getelementptr inbounds %regset, %regset* %0, i32 0, i32 14
  %RIP_init = load i64, i64* %RIP_ptr
  %RIP = alloca i64
...
bb_6A0:                                           ; preds = %entry_fn_6A0
  %RIP_1 = add i64 1696, 1
  %EIP_0 = trunc i64 %RIP_1 to i32
  %IP_0 = trunc i64 %RIP_1 to i16
  %RIP_2 = add i64 %RIP_1, 1
  %EIP_1 = trunc i64 %RIP_2 to i32
  ...
  store i16 %SP_0, i16* %SP
  store i8 %SPL_0, i8* %SPL
  br label %exit_fn_6A0
}

define void @fn_6A4(%regset* noalias nocapture) {
entry_fn_6A4:
  %RIP_ptr = getelementptr inbounds %regset, %regset* %0, i32 0, i32 14
  %RIP_init = load i64, i64* %RIP_ptr
  %RIP = alloca i64
...
bb_6A4:                                           ; preds = %entry_fn_6A4
  %RIP_1 = add i64 1700, 4
  %EIP_0 = trunc i64 %RIP_1 to i32
  %IP_0 = trunc i64 %RIP_1 to i16
  %RSP_0 = load i64, i64* %RSP
  %RSP_1 = sub i64 %RSP_0, 8
...
define void @fn_630(%regset* noalias nocapture) {
entry_fn_630:
  %RIP_ptr = getelementptr inbounds %regset, %regset* %0, i32 0, i32 14
  %RIP_init = load i64, i64* %RIP_ptr
  %RIP = alloca i64
...
bb_630:                                           ; preds = %entry_fn_630
  %RIP_1 = add i64 1584, 2
  %EIP_0 = trunc i64 %RIP_1 to i32
  %IP_0 = trunc i64 %RIP_1 to i16
  ...
  store i32 %CtlSysEFLAGS_0, i32* %CtlSysEFLAGS
  store i32 %EFLAGS_2, i32* %EFLAGS
  store i32 1670, i32* %EIP
  store i16 1670, i16* %IP
  store i64 %RBP_4, i64* %RBP
  store i64 1670, i64* %RIP
  br i1 %CC_E_0, label %bb_686, label %bb_666

bb_666:                                           ; preds = %bb_630
  %RIP_21 = add i64 1638, 2
  %EIP_18 = trunc i64 %RIP_21 to i32
  %IP_18 = trunc i64 %RIP_21 to i16
...
bb_670:                                           ; preds = %bb_670, %bb_666
  %RIP_34 = add i64 1648, 3
  ...
  store i32 1648, i32* %EIP
  store i16 1648, i16* %IP
  store i64 %RBP_6, i64* %RBP
  store i64 %RBX_6, i64* %RBX
  store i64 1648, i64* %RIP
  br i1 %CC_NE_016, label %bb_670, label %bb_686

bb_686:                                           ; preds = %bb_670, %bb_630
  %RIP_24 = add i64 1670, 4
  %EIP_20 = trunc i64 %RIP_24 to i32
  %IP_20 = trunc i64 %RIP_24 to i16
