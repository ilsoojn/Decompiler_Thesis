...
0000000000000000 <.comment>:
  ...
  11:	30 2d 31 36 75 62    	xor    BYTE PTR [rip+0x62753631],ch        # 62753648 <_end+0x62152618>
  ...
  35:	2e 30 2d 31 75 62 75 	xor    BYTE PTR cs:[rip+0x75627531],ch        # 7562756d <_end+0x7502653d>
