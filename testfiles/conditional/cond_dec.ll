...
exit_fn_4005C0:                                   ; preds = %bb_4005C0
  %1 = load i64, i64* %RIP
...
define void @fn_4005C4(%regset* noalias nocapture) {
entry_fn_4005C4:
  %RIP_ptr = getelementptr inbounds %regset, %regset* %0, i32 0, i32 14
  %RIP_init = load i64, i64* %RIP_ptr
  %RIP = alloca i64
...
exit_fn_4005C4:                                   ; preds = %bb_4005C4
  %1 = load i32, i32* %CtlSysEFLAGS
  store i32 %1, i32* %CtlSysEFLAGS_ptr
  %2 = load i32, i32* %EFLAGS
  store i32 %2, i32* %EFLAGS_ptr
...
bb_4005C4:                                        ; preds = %entry_fn_4005C4
  %RIP_1 = add i64 4195780, 4
  %EIP_0 = trunc i64 %RIP_1 to i32
  %IP_0 = trunc i64 %RIP_1 to i16
  %RSP_0 = load i64, i64* %RSP
  %RSP_1 = sub i64 %RSP_0, 8
...
exit_fn_400550:                                   ; preds = %bb_4005A6
...
bb_400550:                                        ; preds = %entry_fn_400550
  ...
  store i32 %CtlSysEFLAGS_0, i32* %CtlSysEFLAGS
  store i32 %EFLAGS_2, i32* %EFLAGS
  store i32 4195750, i32* %EIP
  store i16 1446, i16* %IP
  store i64 %RBP_4, i64* %RBP
  store i64 4195750, i64* %RIP
  br i1 %CC_E_0, label %bb_4005A6, label %bb_400586

bb_400586:                                        ; preds = %bb_400550
  %RIP_21 = add i64 4195718, 2
  %EIP_18 = trunc i64 %RIP_21 to i32
  %IP_18 = trunc i64 %RIP_21 to i16
...
bb_400590:                                        ; preds = %bb_400590, %bb_400586
  %RIP_34 = add i64 4195728, 3
  ...
  store i32 4195728, i32* %EIP
  store i16 1424, i16* %IP
  store i64 %RBP_6, i64* %RBP
  store i64 %RBX_6, i64* %RBX
  store i64 4195728, i64* %RIP
  br i1 %CC_NE_016, label %bb_400590, label %bb_4005A6

bb_4005A6:                                        ; preds = %bb_400590, %bb_400550
  %RIP_24 = add i64 4195750, 4
  %EIP_20 = trunc i64 %RIP_24 to i32
  %IP_20 = trunc i64 %RIP_24 to i16
...
bb_400390:                                        ; preds = %entry_fn_400390
  ...
  store i16 %SP_4, i16* %SP
  store i8 %SPL_4, i8* %SPL
  store i64 4195776, i64* %R8
  store i64 %RDX_0, i64* %R9
  store i8 -64, i8* %R8B
  store i8 %R9B_0, i8* %R9B
  store i32 4195776, i32* %R8D
  store i32 %R9D_0, i32* %R9D
  store i16 1472, i16* %R8W
