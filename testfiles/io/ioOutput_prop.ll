...
%RSP_3 = %RSP-80
%19 = %RSP-80
store i64 4195824, i64* %RSP-80
%ESP_2 = %RSP-80
store i32 %EAX_1, i32* %EAX
store i32 %RSP-8, i32* %EBP
store i32 4196036, i32* %EDI
%ZF_0 = icmp eq i64 %RSP-72, 0
%SF_0 = icmp slt i64 %RSP-72, 0
%20 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %RSP-8, i64 64)
%OF_0 = extractvalue { i64, i1 } %20, 1
%21 = call { i64, i1 } @llvm.usub.with.overflow.i64(i64 %RSP-8, i64 64)
%CF_0 = extractvalue { i64, i1 } %21, 1
%22 = %RSP-72
%23 = call i8 @llvm.ctpop.i8(i8 %RSP-72)
%24 = %23
...
%EAX_2 = %RAX_1
%61 = %RSP-60
store i32 %RAX_1, i32* %RSP-60, align 1
%RIP_12 = 4195843
%EIP_10 = 4195843
%63 = and i32 %RAX_1, -256
%EAX_3 = or i32 %63, 0
...
%RSP_5 = %RSP-88
%65 = %RSP-88
store i64 4195848, i64* %RSP-88
%ESP_3 = %RSP-88
store i32 %EAX_3, i32* %EAX
store i32 4196058, i32* %EDI
store i32 4195848, i32* %EIP
store i32 %RSP-16, i32* %ESI
store i32 %RSP-88, i32* %ESP
store i64 %RAX_3, i64* %RAX
store i64 %RSP-8, i64* %RBP
store i64 4196058, i64* %RDI
store i64 4195848, i64* %RIP
store i64 %RSP-16, i64* %RSI
...
%RBP_2 = %RSP-8
%85 = %RSP-64
store i32 %RAX_3, i32* %RSP-64, align 1
%RIP_17 = 4195866
%EIP_14 = 4195866
%RSP_6 = %RSP-88
%RSP_7 = %RSP-96
%86 = %RSP-96
store i64 4195866, i64* %RSP-96
%ESP_4 = %RSP-96
store i32 %RAX_3, i32* %EAX
store i32 4196061, i32* %EDI
store i32 4195866, i32* %EIP
store i32 %RSP-96, i32* %ESP
store i64 %RAX_3, i64* %RAX
store i64 %RSP-8, i64* %RBP
store i64 4196061, i64* %RDI
store i64 4195866, i64* %RIP
store i64 %RSP-96, i64* %RSP
%89 = load i64, i64* %RAX
...
%EAX_5 = %RAX_3
%106 = %RSP-68
store i32 %RAX_3, i32* %RSP-68, align 1
%RIP_21 = 4195875
%EIP_17 = 4195875
%108 = and i32 %RAX_3, -256
%EAX_6 = or i32 %108, 0
...
%RSP_9 = %RSP-104
%110 = %RSP-104
store i64 4195880, i64* %RSP-104
%ESP_5 = %RSP-104
store i32 %EAX_6, i32* %EAX
store i32 %RSP-56, i32* %EDI
store i32 4195880, i32* %EIP
store i32 %RSP-104, i32* %ESP
store i64 %RAX_6, i64* %RAX
store i64 %RSP-8, i64* %RBP
store i64 %RSP-56, i64* %RDI
store i64 4195880, i64* %RIP
store i64 %RSP-104, i64* %RSP
...
%RBP_4 = %RSP-8
%131 = %RSP-72
store i32 %RAX_6, i32* %RSP-72, align 1
%RIP_26 = 4195887
%EIP_21 = 4195887
%RAX_8 = %ECX_1
...
%136 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %RSP-104, i64 64)
%OF_1 = extractvalue { i64, i1 } %136, 1
%137 = call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %RSP-104, i64 64)
%CF_1 = extractvalue { i64, i1 } %137, 1
%138 = %RSP-40
%139 = call i8 @llvm.ctpop.i8(i8 %RSP-40)
%140 = %139
%PF_1 = icmp eq i1 %139, false
%141 = %137
%142 = shl i32 %137, 0
%144 = %PF_1
%145 = shl i32 %PF_1, 2
