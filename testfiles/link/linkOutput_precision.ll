...
%c = alloca i32
store i32 %CtlSysEFLAGS_init, i32* %c
br label %bb_400650
...
%14 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %a, i64 16)
...
%55 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %b, i64 16)
%OF_1 = extractvalue { i64, i1 } %55, 1
%56 = call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %b, i64 16)
...
%ZF_0 = icmp eq i64 %RSP-24, 0
%SF_0 = icmp slt i64 %RSP-24, 0
%19 = call { i64, i1 } @llvm.ssub.with.overflow.i64(i64 %a, i64 16)
%OF_0 = extractvalue { i64, i1 } %19, 1
%20 = call { i64, i1 } @llvm.usub.with.overflow.i64(i64 %a, i64 16)
...
%ESP_8 = %RSP-24
%EIP_21 = %c
%ZF_1 = icmp eq i64 %f, 0
%SF_1 = icmp slt i64 %f, 0
%126 = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %h, i64 16)
%OF_1 = extractvalue { i64, i1 } %126, 1
%127 = call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %h, i64 16)
%CF_1 = extractvalue { i64, i1 } %127, 1
%128 = %f
%129 = call i8 @llvm.ctpop.i8(i8 %f)
%130 = %129
